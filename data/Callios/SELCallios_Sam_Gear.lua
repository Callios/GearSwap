...
function init_gear_sets()
    ...
    sets.precast.Waltz = {
        ...
        back="Moonbeam Cape",waist="Chaac Belt",legs="Wakido Haidate +3",feet="Sak. Sune-Ate +1"}
    ...
    sets.resting = {ammo="Staunch Tathlum +1",
        ...
        back="Moonbeam Cape",waist="Flume belt +1 +1",legs="Wakido Haidate +3",feet="Flam. Gambieras +2"}
    ...
    sets.idle = {ammo="Staunch Tathlum +1",
        ...
        back="Moonbeam Cape",waist="Flume belt +1 +1",legs="Nyame Flanchard",feet="Danzo Sune-ate"}
    ...
    sets.idle.Weak = {ammo="Staunch Tathlum +1",
        ...
        back="Moonbeam Cape",waist="Flume belt +1 +1",legs="Flamma Dirs +2",feet="Danzo Sune-ate"}
    ...
    sets.defense.PDT = {ammo="Staunch Tathlum +1",
        ...
        back="Moonbeam Cape",waist="Ioskeha Belt",legs="Wakido Haidate +3",feet="Nyame Sollerets"}
...
--[[Right now Adoulin sets are the same as non-Adoulin.
    ...
    sets.engaged.Adoulin.PDT = {ammo="Staunch Tathlum +1",
        ...
        back="Moonbeam Cape",waist="Flume belt +1 +1",legs="Wakido Haidate +3",feet="Amm Greaves"}
