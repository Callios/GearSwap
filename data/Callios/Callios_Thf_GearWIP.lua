...
function init_gear_sets()
	...
	-- Weapons sets
	sets.weapons.Aeneas = {main="Aeneas",sub="Centevento"}
    ...
    sets.precast.WS["Rudra's Storm"] = set_combine(sets.precast.WS, {ammo="Cath Palug Stone",
        head="Plunderer's Bonnet +3",neck="Assassin's Gorget +2",ear1="Moonshade Earring",ear2="Sherida Earring",
        body="Plunderer's Vest +3",hands="Meghanada Gloves +2",ring1="Ilabrat Ring",ring2="Regal Ring",
        back=gear.THFCape_DEXWS,waist="Grunfeld Rope",legs="Plunderer's Culottes +3",feet="Plunderer's Poulaines +3"})
    ...
    sets.precast.WS["Mandalic Stab"] = set_combine(sets.precast.WS, {ammo="Cath Palug Stone",
        head="Adhemar Bonnet +1",neck="Assassin's Gorget +2",ear1="Moonshade Earring",ear2="Sherida Earring",
    ...
    sets.precast.WS['Evisceration'] = set_combine(sets.precast.WS, {ammo="Yetshila +1",
        ...
        back=gear.eviscape,waist="Fotia Belt",legs="Pillager's Culottes +3",feet="Lustratio Leggings +1"})
    ...
    sets.precast.WS["Savage Blade"] = set_combine(sets.precast.WS, {ammo="Seething Bomblet +1", 
         head="Nyame Helm",
         body="Nyame Mail",hands="Nyame Gauntlets",ring1="Regal Ring", ring2="Epaminondas Ring", 
    ...
    sets.precast.WS['Aeolian Edge'] = {ammo="Seething Bomblet +1",
        ...
        body="Nyame Mail",hands="Nyame Gauntlets",ring1="Dingir Ring",ring2="Epaminondas Ring",
    ...
    sets.idle.TP = {ammo="Ginsen",
        ...
        body="Malignance Tabard",hands="Malignance Gloves",ring1="Chirich Ring +1",ring2="Chirich Ring +1",
        back="Moonbeam Cape",waist="Reiki Yotai",legs="Malignance Tights +2",feet="Jute Boots +1"}   
    ...
    sets.engaged = {ammo="Ginsen",
        head="Adhemar Bonnet +1",neck="Combatant's Torque",ear1="Dedition Earring",ear2="Sherida Earring",
        body="Adhemar Vest +1",hands="Adhemar Wristbands +1",ring1="Epona's Ring",ring2="Hetairoi Ring",
        back=gear.THFCape_TP,waist="Reiki Yotai",legs="Samnuha Tights",feet=gear.HercFeetTP}
        
    sets.engaged.SomeAcc = {ammo="Yamarang",
        head="Plunderer's Bonnet +3",neck="Assassin's Gorget +2",ear1="Telos Earring",ear2="Sherida Earring",
        body="Pillager's Vest +3",hands="Adhemar Wristbands +1",ring1="Gere Ring",ring2="Hetairoi Ring",
        back=gear.THFCape_TP,waist="Reiki Yotai",legs="Pillager's Culottes +3",feet="Plunderer's Poulaines +3"}
    ...
    sets.engaged.FullAcc = {ammo="Cath Palug Stone",
        head="Malignance Chapeau",neck="Assassin's Gorget +2",ear1="Telos Earring",ear2="Mache Earring +1",
    ...
    sets.engaged.SomeAcc.DT = {ammo="Yamarang",
        head="Malignance Chapeau",neck="Assassin's Gorget +2",ear1="Telos Earring",ear2="Odnowa Earring +1",
        body="Malignance Tabard",hands="Malignance Gloves",ring1="Gere Ring",ring2="Moonlight Ring",
        back=gear.THFCape_TP,waist="Reiki Yotai",legs="Malignance Tights",feet="Malignance Boots"}
