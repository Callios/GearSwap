...
function init_gear_sets()
	...
	sets.precast.FC = {ammo="Impatiens",
		...
		back="Moonbeam Cape",waist="Flume belt +1 +1",legs="Founder's Hose",feet="Carmine Greaves +1"}
	...
	sets.defense.PDT = {ammo="Staunch Tathlum +1",
		...
		back="Shadow Mantle",waist="Flume belt +1 +1",legs="Arke Cosc. +1",feet="Amm Greaves"}
	...
	sets.defense.MDT = {ammo="Staunch Tathlum +1",
		...
		body="Tartarus Platemail",hands="Sulev. Gauntlets +2",ring1="Gelatinous Ring +1",ring2="Moonlight Ring",
		back="Moonbeam Cape",waist="Flume belt +1 +1",legs="Arke Cosc. +1",feet="Amm Greaves"}
    ...
    sets.passive.MP = {ear2="Ethereal Earring",waist="Flume belt +1 +1"}
