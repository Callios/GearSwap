...
function init_gear_sets()
    ...
    sets.Enmity.DT = {main="Aettir",sub="Utu Grip",ammo="Staunch Tathlum +1",
        ...
        back="Moonbeam Cape",waist="Flume belt",legs="Eri. Leg Guards +1",feet="Nyame Sollerets"}
    ...
    sets.idle = {main="Aettir",sub="Utu Grip",ammo="Homiliary",
		...
		back="Moonbeam Cape",waist="Flume belt",legs="Rawhide Trousers",feet=gear.herculean_refresh_feet}
	...
	sets.idle.KiteTank = {main="Aettir",sub="Utu Grip",ammo="Staunch Tathlum +1",
        ...
        back="Moonbeam Cape",waist="Flume belt",legs="Carmine Cuisses +1",feet="Hippo. Socks +1"}
