...
function init_gear_sets()
	...
	sets.precast.WS.Proc = {ammo="Yamarang",
        ...
        back="Moonbeam Cape",waist="Flume belt",legs="Dashing Subligar",feet="Ahosi Leggings"}
    ...
    sets.idle = {ammo="Staunch Tathlum +1",
        ...
        back="Shadow Mantle",waist="Flume belt",legs="Nyame Flanchard",feet="Malignance Boots"}
