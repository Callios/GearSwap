...
- \cs(66, 227, 245)HP :\cr ${pet_current_hp|0}/${pet_max_hp|0}
...
- \cs(66, 227, 245)Maneuver Queue: \cr ${maneuver_queue|0}
- \cs(66, 227, 245)Current Queue: \cr ${current_queue|0}
${current_pet_skills|- No Skills To Track}
]]

    hub_state_std = [[ \cs(255, 115, 0)======= State ============\cr
-\cs(66, 227, 245)${key_bind_pet_mode} Pet Mode :\cr ${pet_current_mode|TANK}
-\cs(66, 227, 245)${key_bind_pet_style} Pet Style :\cr ${pet_current_style|NORMAL}
-\cs(66, 227, 245) Combined State :\cr ${player_pet_state|Idle}
]]

    hub_mode_std = [[ \cs(255, 115, 0)======= Mode ============\cr
-\cs(66, 227, 245)${key_bind_idle} Idle Mode :\cr ${player_current_idle|Idle}
-\cs(66, 227, 245)${key_bind_offense} Offense Mode :\cr ${player_current_offense|MasterPet}
-\cs(66, 227, 245)${key_bind_physical} Physical Mode :\cr ${player_current_physical|PetDT}
-\cs(66, 227, 245)${key_bind_hybrid} Hybrid Mode :\cr ${player_current_hybrid|Normal}
]]

    hub_options_std = [[ \cs(255, 115, 0)======= Options ==========\cr
-\cs(66, 227, 245)${key_bind_auto_maneuver} Auto Maneuver :\cr ${toggle_auto_maneuver|OFF}
-\cs(66, 227, 245)${key_bind_pet_dt} Lock Pet DT Set :\cr ${toggle_lock_pet_dt_set|OFF}
-\cs(66, 227, 245)${key_bind_lock_weapon} Lock Weapon :\cr ${toggle_lock_weapon|OFF}
-\cs(66, 227, 245) Weaponskill FTP :\cr ${toggle_weaponskill_ftp|OFF}
-\cs(66, 227, 245) Custom Gear Lock :\cr ${toggle_custom_gear_lock|OFF}
-\cs(66, 227, 245) Auto Deploy :\cr ${toggle_auto_deploy|OFF}
]]
