...
function init_gear_sets()
 ...
 sets.precast.WS['Stardiver'] = set_combine(sets.precast.WS, {ammo="Knobkierrie",
        head="Mpaca's Cap",
        neck="Samurai's Nodowa +2",
        ear1="Schere",ear2="Moonshade Earring",
    ...
    sets.precast.WS['Tachi: Jinpu'] = {ammo="Knobkierrie",
        head="Nyame Helm",neck="Samurai's Nodowa +2",ear1="Friomisi Earring",ear2="Moonshade Earring",
        body="Nyame Mail",hands="Nyame gauntlets",ring1="Regal Ring",ring2="Epaminondas's Ring",
        back=CapeWSD,waist="Orpheus's Sash",legs="Nyame Flanchard",feet="Nyame Sollerets"}
...
sets.precast.WS['Namas Arrow'] = {ranged="Yoichinoyumi",ammo="Yoichi's Arrow",
        head="Nyame helm",neck="Samurai's Nodowa +2",ear1="Telos Earring",ear2="Thrud Earring",
        body="Nyame Mail",hands="Nyame Gauntlets",ring1="Regal Ring",ring2="Ilabrat ring",
        back=CapeRNGWS,waist="Fotia Belt",legs="Wakido haidate +3",feet="Nyame Sollerets"}
